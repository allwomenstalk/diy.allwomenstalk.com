---
title: "7 Less Obvious Uses for a Turkey Baster ..."
...
## 1. Emergency Wine Stopper

I’m going to have to wait until February it try out this one, because I’m starting off the New Year with Dry January (read about it here [health.allwomenstalk.com](https://health.allwomenstalk.com/start-the-new-year-off-right-with-dry-january-no-drinking-for-days/)). Apparently, one of those less obvious uses for a turkey baster is to preserve an open bottle of wine. Just drop the baster into the neck of the bottle and hey presto – instant wine saver.
...
## 4. Degrease Sauces and Stocks and Soups (and Anything else)
...
- [HTML article](https://diy.allwomenstalk.com/less-obvious-uses-for-a-turkey-baster/)
