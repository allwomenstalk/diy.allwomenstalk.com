---
title: "7 Drawing Websites to Visit when Youre Bored ..."
...
# 7 Drawing Websites to Visit when Youre Bored ...

Whether you're an artist or just like to doodle, there are some entertaining drawing websites out there. The next time you're bored, check them out, because they could waste hours of your time. Plus, they might even make you better at art! Here are some of the best drawing websites that will keep you entertained:

## 1. OnDraw

[OnDraw](https://ondraw.web.app/)  is the perfect site for anyone who loves to draw! The easy to use UI and clear, pleasant look make it a great choice for anyone looking to create something right away. Plus, the all you need tools let you create anything you can imagine! Whether you're a beginner or a seasoned artist, you'll find everything you need to create stunning artwork on this site.

## 2. Draw a Stickman

[Drawastickman.com](https://drawastickman.com/) is about as fun as it gets. You start off by drawing a tiny person. After that, the game asks you to draw certain things in the character's hands, like a key and a balloon. Then the game animates your character to take him on an adventure. There are only two different adventures to go on, but they're equally as exciting. It's bound to keep you occupied for a while.

## 3. Sketch

[Sketch.io](https://sketch.io/sketchpad/) allows you to draw amazing pictures. It has more functions that just a paintbrush and pen. It also has calligraphy, stamp, and spiderweb options. You can even add clipart or type in some text to add to the image. You can pretty much do anything that your mind could ever imagine.

## 4. Doodletoo

[Doodletoo.com](https://goo.gl/wVe9Qh) is a place to show off your art skills and compare them to other's artwork. It's basically a group drawing board where a bunch of people share one easel. Sometimes, you'll come across the most beautiful pictures you've ever seen. Other times, you'll just see ridiculous scribbles. It all depends on whom you're stuck in the lobby with. Just don't use this website to draw a masterpiece, because someone could easily ruin it, and you don't want to end up upset.

## 5. One Motion

Here's another website that allows you to create an image of your very own. [Onemotion.com](https://web.archive.org/web/http://www.onemotion.com/flash/sketch-paint/) starts by asking you how big you want your image to be. Then it lets you do whatever your heart desires. You can pick the size, pressure, and diffusion of the paintbrush that you use. Scatter and shake are also options.

## 6. Bomomo

[Bomomo.com](https://bomomo.com/) is a great way to waste time. Just click the link and see for yourself. It allows you to draw awesome shapes on a page without doing much work of your own. It's not a website to visit if you actually want to create your own work. It's more of a time waster where you get to look at the pretty colors. All you really have to do is click and drag.

## 7. Draw Your Own Cartoon Character

[Agame.com](https://www.agame.com/game/draw_your_own_cartoon_character) allows you to draw your own cartoon character. All you have to do is draw arms, legs, and a body. Once you're done, the game will automatically animate your character. Sure, it's a kid's game, but it's still pretty entertaining.
...
- [HTML article](https://diy.allwomenstalk.com/drawing-websites-to-visit-when-youre-bored/)
