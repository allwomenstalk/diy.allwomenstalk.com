...
![Embroidery](https://resize.allw.mn/1028x0/filters:format(webp)/filters:quality(70)/content/kr/n3/telvrz77_600x450.jpg)

With a needle and some thread, you can spruce up any piece of fabric you may have lying around. You can can sew fun patterns, symbols, and even lettering to create an embroidered masterpiece. Make your mark on anything from cushion covers to clothing to canvas wall art.

## 7. Appliqué

![Appliqué](https://resize.allw.mn/1028x0/filters:format(webp)/filters:quality(70)/content/x7/pd/tq8cgvzd_600x398.jpg)

The art of appliqué involves attaching a small detail onto a larger piece. Usually this involves attaching a small piece of fabric to a larger piece, either by stitching or using an iron-on technique. Create fun appliquéd patterns or letters to update anything from clothing to fabric furnishings.
...
- [HTML article](https://diy.allwomenstalk.com/suddenly-cool-crafts-youll-want-to-learn-now/)
